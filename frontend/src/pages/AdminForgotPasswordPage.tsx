      ...
      <div className="admin-login-card card">
        <div className="login-header">
          ...
          <p>
            ...
            {step === 'PASSWORD' && 'Create a new secure administrator password'}
            {step === 'SUCCESS' && 'Access successfully restored'}
          </p>
        </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0.5rem', marginBottom: '1.5rem' }}>
            <span
              style={{
                ...
                borderRadius: '9999px',
                background: step === 'EMAIL' ? 'var(--primary, #10b981)' : 'rgba(255,255,255,0.08)',
            ...
            <span
              style={{
                ...
                padding: '0.2rem 0.6rem',
                borderRadius: '9999px',
                background: step === 'OTP' ? 'var(--primary, #10b981)' : 'rgba(255,255,255,0.08)',
            ...
            <span
              style={{
                ...
                padding: '0.2rem 0.6rem',
                borderRadius: '9999px',
                background: step === 'PASSWORD' ? 'var(--primary, #10b981)' : 'rgba(255,255,255,0.08)',
        ...
        {step === 'EMAIL' && (
          <form onSubmit={handleSendOtp}>
            <div className="form-group">
              <label htmlFor="admin-recovery-email">Registered Email Address</label>
        ...
        {step === 'OTP' && (
          <form onSubmit={handleVerifyOtp}>
            ...
            <div className="form-group">
              <label htmlFor="admin-otp" style={{ textAlign: 'center', display: 'block' }}>
        ...
        {step === 'PASSWORD' && (
          <form onSubmit={handleResetPassword}>
            <div className="form-group">
              <label htmlFor="admin-new-password">New Administrator Password</label>
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                <input
        ...
        {step === 'SUCCESS' && (
          <div style={{ textAlign: 'center', padding: '1rem 0' }}>
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: '1.6', marginBottom: '1.75rem' }}>
              Your administrator password has been successfully updated. You can now use your new credentials to sign in.
            </p>
            <button
            ...
            >
              <ArrowLeft size={16} /> Return to Login Gateway
            </button>
          </div>
        )}

        {/* Return to Login link for steps 1-3 */}
        {step !== 'SUCCESS' && (
          <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
            ...
            >
              <ArrowLeft size={14} /> Return to Login Gateway
            </span>
          </div>
        )}
      </div>
